...
/** 
 * <p>Clase encargada de gestionar los errores producidos en TSCliente.</p>
 * 
...
public class TSClienteError extends Exception {
	...
	/** 
	 * <p>Crea una nueva instancia de TSClienteError.<p>
	 */
	...
	/**
	 * <p>Devuelve una descripción corta de la excepción.</p>
	 * @return "Nombre de la clase":"Mensaje de la excepción"
	 */
